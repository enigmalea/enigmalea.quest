...
Before you start, you'll need to create two accounts if you'd like to receive
notifications in Discord. I recommend that you use google login if your mod team
shares a gmail account, that way there's no additional passwords to remember or
share.
...
IFTTT or Zapier) with very generous monthly limits. It also allows you to
execute custom code, which is useful for creating customized messages with
embeds, images, and other data besides plain text. <span className="inlineNote">You
do not need to sign-up for Pipedream if you do not want Discord
notifications.</span>

<!-- prettier-ignore-end -->

**For Discord Notifications:** You will also need to create a webhook URL
pointed to the channel where you would like to receive your notifications.
Please see [Creating Discord Webhooks](/docs/tutorials/webhooks) for
...
1. Click on the <i class="fa-solid fa-angle-down"></i> and select "Edit field".
...
1. Click the large <i class="fa-solid fa-plus"></i> at the end of the existing
   fields.
...
**To Create a New View:** In the left hand sidebar at the bottom, click the <i class="fa-solid fa-plus"></i>
