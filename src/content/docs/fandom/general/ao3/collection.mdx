...
2. Under Associations, click in the _Post to Collections/Challenges_ field and
   ...
   in a pop-up. If so, you can select it. If not, hit
   tab.!['screenshot from AO3 new works page with the Post to Collection field completed'](../../../../../assets/img/ao3/collections_new_work.png)
