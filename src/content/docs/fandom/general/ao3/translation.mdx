...
3. Enter the URL for the work on AO3 and select the language in the dropdown
   ...
   ![A screenshot of the AO3 "New Works" form with the translation options showing.](../../../../../assets/img/ao3/translation.png)
...
3. AO3 automatically adds a Note to each work linking the two!
   ![A screenshot of an AO3 translation note.](../../../../../assets/img/ao3/translation_note.png)
