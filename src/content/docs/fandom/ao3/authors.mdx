...
![A screenshot of the AO3 preferences page showing the "Privacy" settings.](../../../../../assets/img/ao3/authors_prefs.png)
...
3. Type in the username you want to add. The username should pop-up for you.
   ...
   ![A screenshot of the AO3 "Post Works" form with "Add co-creators" selected and a username being searched for.](../../../../../assets/img/ao3/authors_add.png)
